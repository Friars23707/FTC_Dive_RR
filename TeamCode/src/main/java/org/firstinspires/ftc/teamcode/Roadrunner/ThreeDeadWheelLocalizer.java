...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = 0.0; // y power of the first parallel encoder (in tick units)
        public double par1YTicks = 1.0; // y power of the second parallel encoder (in tick units)
        public double perpXTicks = 0.0; // x power of the perpendicular encoder (in tick units)
    }
