...
public class MecanumDrive {
    public static class Params {
        ...
        public double lateralInPerTick = 0.6758717436720546; // Tune this with LateralRampLogger (even if you use OTOS/Pinpoint)
        public double trackWidthTicks = 16.094882767249068;

        // feedforward parameters (in tick units)
        public double kS = 1.2531920729262547;
        public double kV = 0.13623582437556167;
